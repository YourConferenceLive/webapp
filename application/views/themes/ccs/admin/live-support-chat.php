    ...
    function listAllUsers()
    {
        $.get(project_url+"/admin/users/allUsersJson/", function (users) {
            ...
            $.each(users, function(i, user) {
                $('.users-list').append(
                    '<li class="users-list-item list-group-item w-100" user-id="'+user.id+'" user-name="'+user.name+' '+user.surname+'" new-text="0">'+user.name+' '+user.surname+'<img class="typingHint" src="'+ycl_root+'/theme_assets/ccs/live_support/typing-animation-3x.gif" style="margin-left: 20px;width: 30px;display: none;"> <span class="badge badge-danger ml-2" style="display: none;">new</span></li>'
                );
            });
