                            ...
                            foreach ($session_resource as $val) {
                                ...
                                <div class="row" style="margin-bottom: 10px; padding-bottom: 5px">
                                    <?php if ($val->resource_type == "url") { ?>
                                        <div class="col-md-12"><a class="resources-link-text" href="<?= $val->resource_path ?>" target="_blank" style="color: #EF5D21 !important; font-size: 22px"><?= $val->resource_name ?></a></div>
                                    <?php } ?>
                                    <?php
