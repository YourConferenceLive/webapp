...
<link rel="stylesheet" href="<?=ycl_root?>/theme_assets/ccs/live_support/style.css?v=2">
<script src="<?=ycl_root?>/theme_assets/ccs/live_support/live-support-chat.js?v=2"></script>
