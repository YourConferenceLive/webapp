...
<style>
	<?php if(file_exists(FCPATH."cms_uploads/projects/{$this->project->id}/theme_assets/ccs/register_background.jpg")): ?>
	body{
		background-image: url("<?=ycl_root?>/cms_uploads/projects/<?=$this->project->id?>/theme_assets/ccs/register_background.jpg");
...
<link href="<?=ycl_root?>/theme_assets/ccs/<?=$this->project->theme?>/css/login.css" rel="stylesheet">
<body class="text-center">
<form class="form-signin">

	<div class="mb-4">
		<img src="<?=ycl_root?>/cms_uploads/projects/<?=$this->project->id?>/theme_assets/ccs/logo.png" alt="<?=$this->project->name?> Logo" style="max-width: 100%;max-height: 100%;">
	</div>
