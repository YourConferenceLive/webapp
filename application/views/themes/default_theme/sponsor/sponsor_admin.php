...
<script src="<?=ycl_root?>/theme_assets/default_theme/js/sponsor_admin.js"></script>
...
?>
	<main role="main">
		...
		<div class="container-fluid px-lg-5">
			<div class="row ">
				<div class="col ">
					<div class="fa fa-edit btn btn-outline-info float-right btn-lg btn-customize"> customize </div>
				</div>
			</div>
			<div class="row">
...
<!-- ######################## Icons List Start ################################-->
								...
								<div class="input-group ">
									<div class="input-group-prepend ">
										<div class="input-group-text py-0  bg-light">
											<a target="_blank" class="btn p-0 " ><i class="fa fa-globe fa-2x m-0"></i></a>
											<input type="text" id="website" disabled class="form-control shadow-none" placeholder="https://website" value="<?=(isset($data->website_link) && !empty($data->website_link))?$data->website_link:''?>">
										</div>
										<div class="input-group-text btn bg-light btn-save-website" hidden>
											<i class="fa fa-pencil-square-o  text-primary text-secondary"  aria-hidden="true">save</i>
										</div>
									</div>
								</div>
							</div>
							<div class="form-group  float-md-right mx-sm-auto mr-m-2">
								...
								<div class="input-group ">
									<div class="input-group-prepend ">
										<div class="input-group-text py-0 bg-light">
											<a target="_blank" class="btn p-0"><i class="fa fa-twitter fa-2x  m-0"></i></a>
										...
										<div class="input-group-text btn bg-light btn-save-twitter" hidden>
											<i class="fa fa-pencil-square-o text-secondary"  aria-hidden="true">save</i>
										</div>
									</div>
								</div>
							</div>
							<div class="form-group  float-md-right mx-sm-auto mr-m-2">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="input-group-text py-0 bg-light">
											<a target="_blank" class="btn p-0"><i class="fa fa-facebook fa-2x  m-0"></i></a>
							...
							<div class="form-group  float-md-right mx-sm-auto mr-m-2">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="input-group-text py-0 bg-light">
											<a target="_blank" class="btn p-0"><i class="fa fa-linkedin fa-2x m-0"></i></a>
					...
					<div class="group-chat card ">
						<div class="">
							<div class="group-chat-header card-header text-white bg-blue ">
								...
								<i class="btn badge badge-light float-right ml-2"><span class="fa fa-save"> save </span></i>
								<i class="btn badge badge-light float-right"><span class="fa fa-trash-o"> clear </span></i>
							</div>
							...
							<div class="group-chat-footer card-footer bg-light">
								<div class="input-group">
									...
									<div class="input-group-append"><span class="btn fa  fa-paper-plane-o form-control bg-blue text-white btn-group-send" aria-hidden="true"> send</span></div>
								</div>
							</div>
						</div>
					</div>
...
<!--				############# SPONSOR CHAT ##########################-->
				...
				<div class="col-xl-7 col-lg-8 col-md-12 ">
					<div class="sponsor-card card ">
						<div class="card-header bg-blue text-white"> Attendees <i class="fa fa-comments-o"> </i>
								...
								<div class="card w-md-100 overflow-auto attendee-list position-absolute">
									<div class="card-header">
										<div class="input-group ">
											...
											<div class="input-group-append"><span class="btn fa fa-search form-control bg-blue" aria-hidden="true" ></span></div>
										</div>
									</div>
									...
									<div class="sponsor-chat-footer card-footer ">
										<div class="input-group">
											...
											<div class="input-group-append">
												<span class="btn fa  fa-paper-plane-o form-control bg-blue text-white btn-sponsor-send" aria-hidden="true"> send</span>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="card-header availability p-0  bg-light-blue  btn btn-collapse" data-toggle="collapse" data-target="#availability-body">
							<div class="availability-title">
								<div class="row text-white m-2">
									<h5 class="" style="color: #31708F"> <i class="fa fa-calendar fa-2x"></i> Set Availability <span class="fa fa-caret-down"></span> </h5>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-lg-4 col-md-12">
									<div class="input-group mb-3">
										<div class="input-group-prepend ">
											<span class="input-group-text fa fa-calendar-plus-o pt-2" id="basic-addon2"> <small> Add another availability</small> </span>
										</div>
								...
								<div class="col-lg-6 col-md-12">
									<div class="card availability-list">
										<div class="availability-list-header card-header text-green">
					...
					<div class="card current-bookings w-100" >
						<div class="card-header p-0  bg-light-green btn booking-header" >
							<div class="card-title">
								<div class="row text-white m-2">
									<h5 class="" style="color: #3C763D"> <i class="fa fa-calendar-check-o fa-2x"></i> 	<?= (isset($data->name) && !empty ($data->name))?$data->name:'' ?> Current Bookings </h5>
									<span>
