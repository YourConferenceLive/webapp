		...
		<div class="navbar-collapse collapse" id="navbarCollapse" style="">
			...
			<ul class="navbar-nav mr-5" >
				<li class="nav-item active">
					<a class="nav-link" href="<?=$this->project_url.'/sponsor/admin/home/'?>">Home <span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?=$this->project_url.'/sponsor/admin/fish_bowl/'?>">Fish Bowl</a>
				</li>
