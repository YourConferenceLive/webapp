...
<div id="presentationEmbed">
	<div id="presentationRow" class="row m-0 p-0">
		<span style="position: absolute;color: white;z-index: 2;left: 15px;"><a class="btn btn-sm btn-info mt-2" href="<?=$session->zoom_link?>" target="_blank" <?=($session->zoom_link == null)?'onclick="toastr.warning(`Zoom is not configured yet.`); return false;"':''?>><i class="fas fa-video"></i> Join Zoom</a></span>
