...
<script src="<?=ycl_root?>/theme_assets/default_theme/js/sponsor_attendee.js"></script>
...
<!--	<div class="container-fluid ">-->
	<div class="container-fluid">
		<div class="jumbotron "
			 style="background-image: url('<?= (isset($data->cover_photo) && !empty($data->cover_photo)) ?  ycl_root . '/cms_uploads/projects/'.$this->project->id.'/sponsor_assets/uploads/cover_photo/' . $data->cover_photo:'' ?> ')">
			<div class="">
				<div class="col">
				...
				<div class="col ml-xl-3 ml-md-0">
					...
					<div class="row justify-content-center mb-2">
						<div class="col website-icons text-center">
							...
							<a href="https://www.facebook.com/<?=(isset($data->facebook_link) && !empty($data->facebook_link)?$data->facebook_link : '')?>" target="_blank" class="btn p-0" title="<?=(isset($data->facebook_link) && !empty($data->facebook_link)?$data->facebook_link : '')?>"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
							<a href="https://www.twitter.com/<?=(isset($data->twitter_link) && !empty($data->twitter_link)?$data->twitter_link : '')?>" target="_blank" class="btn p-0" title="twitter.com/<?=(isset($data->twitter_link) && !empty($data->twitter_link)?$data->twitter_link : '')?>"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
							<a class="btn p-0" title="<?=(isset($data->linkedin_link) && !empty($data->linkedin_link)?$data->linkedin_link : '')?>"><i class="fa fa-linkedin fa-2x" aria-hidden="true"></i></a>
						</div>
					</div>
				</div>
			</div>
								...
								<div class="group-chat-footer card-footer bg-light">
									<div class="input-group">
										...
										<div class="input-group-append btn-group-send">
											<i class="btn btn-primary fa  fa-paper-plane-o form-control send-group-message pt-2"
								...
								<div class="col-md-12 float-right">
									<div class="card">
										<div class="sponsor-chat-header card-header text-white"
											...
											Sponsor Chat
											<i class="btn badge badge-light float-right ml-2" id="sponsor-call"><span class="fa fa-phone"> call </span></i>
											<i class="btn badge badge-light float-right" id="schedule-a-meet"><span class="fa fa-calendar-check-o"> schedule a meet </span></i>
										</div>
										...
										<div class="sponsor-chat-footer card-footer ">
											<div class="input-group">
												...
												<div class="input-group-append btn-sponsor-send">
													<span class="btn btn-primary fa  fa-paper-plane-o form-control send-sponsor-message pt-2" aria-hidden="true" style="background-color: #337AB7"> send</span>
												</div>
											</div>
										</div>
									</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class=" input-group">
					<input type="text" id="date-time-picker" class="form-control p-4 shadow-none" style="cursor: pointer" readonly><span class="btn btn-success" ><i class="fa fa-calendar-plus-o fa-2x"></i> BOOK</span>
				</div>
				</div>
