...
<object id="shPdf" data="<?=ycl_root?>/cms_uploads/projects/3/theme_assets/scavenger_hunt/Scavenger_Hunt_Instructions.pdf" type="application/pdf" width="100%" height="900px" style="margin-top: 69px;">
