...
class MYPDF extends TCPDF {
    ...
    public function Header() {
		$header = 'cms_uploads'.DIRECTORY_SEPARATOR.'projects'.DIRECTORY_SEPARATOR.PROJECT_ID.DIRECTORY_SEPARATOR.'theme_assets'.DIRECTORY_SEPARATOR.'briefcase'.DIRECTORY_SEPARATOR.'pdf-header.jpg';
    ...
    public function Footer() {
		...
		$footer 		= 'cms_uploads'.DIRECTORY_SEPARATOR.'projects'.DIRECTORY_SEPARATOR.'3'.DIRECTORY_SEPARATOR.'theme_assets'.DIRECTORY_SEPARATOR.'briefcase'.DIRECTORY_SEPARATOR.'pdf-footer.png';
...
$signaute 		= 'cms_uploads'.DIRECTORY_SEPARATOR.'projects'.DIRECTORY_SEPARATOR.'3'.DIRECTORY_SEPARATOR.'theme_assets'.DIRECTORY_SEPARATOR.'briefcase'.DIRECTORY_SEPARATOR.'pdf-signature.jpg';
