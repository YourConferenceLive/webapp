					...
					<div class="row mt-2">
						...
						<div class="col-md-9 col-sm-12 pl-0 pt-2">
							...
							<div class="col-12 text-md-right text-sm-center">
								<button class="btn btn-sm btn-info m-1 rounded-0"><i class="fas fa-calendar-check"></i> Export To Calender</button>
								<button class="btn btn-sm btn-success m-1 rounded-0"><i class="fas fa-plus"></i> JOIN</button>
							</div>
						</div>
					</div>
				</div>
