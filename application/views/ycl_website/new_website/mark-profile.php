...
<html class="wide wow-animation" lang="en">
  <head>
    <!-- Site Title-->
    <title>Mark Rosenthal - Your Conference Live - One World Presentation Management</title>
  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="section-xl bg-white novi-background bg-cover">
        <div class="container">
          <!-- Profile Corporate-->
          <article class="profile-corporate"><img class="profile-corporate__image" src="<?=ycl_root?>/ycl_assets/images/homepage_images/mark-rosenthal-480x362.jpg" alt="" width="886" height="666"/>
            <div class="profile-corporate__caption">
              <p class="profile-corporate__title">Mark Rosenthal</p>
              <p class="profile-corporate__subtitle">Senior Consultant</p>
              <p>Long-time industry expert, Mark Rosenthal has taken his 35 years’ experience in the conference/presentation industry and applied imagination and technology to develop solutions to the association and conference community. It was Mark who originally coined the phrase, “presentation management”, to draw a distinction between the skilled attention required to maintain the integrity of presentations and basic file management, which has largely been the standard of large AV companies. Mark designed the first software solutions for online advance submissions for presentations, as well as, onsite organization of presentations.</p>
