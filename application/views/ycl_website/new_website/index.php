        ...
        <div class="container">
          <div class="row row-fix justify-content-md-center align-items-lg-end">
            <div class="col-md-8 col-lg-6 section-xl">
              ...
              <p>Analytics? Collaboration? Ease of Use? </p>YCL has everything to get you covered. Producers, technicians, and global reach, all on the fastest platform you will find. </p><a class="button button-gray-light-outline" href="#">View now!</a>
            </div>
