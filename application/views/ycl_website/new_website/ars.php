...
<div class="page">
	...
	<header class="page-header">
      ...
      <section class="breadcrumbs-custom novi-background bg-cover">
        <div class="container">
          <div class="breadcrumbs-custom__inner">
            <p class="breadcrumbs-custom__title">Audience Response Systems</p>
      ...
      <section class="text-center">
        <!-- RD Parallax-->
        <div class="parallax-container bg-image parallax-header rd-parallax-light" data-parallax-img="<?=base_url()?>ycl_assets/images/homepage_images/services_ars.jpg">
                ...
                <div class="container">
                  <div class="row justify-content-sm-center">
                    <div class="col-md-10 col-xl-8">
                      <h2>Professional and Precise</h2>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section class="bg-accent section-lg novi-background bg-cover">
        <div class="container">
          <div class="row row-fix">
            ...
            <div class="col-md-8">
              <p> YCL has everything to you need for a successful event. Let our experienced team help evaluate your objectives and put together a comprehensive plan that will impress your membership.</p><a class="button button-gray-light-outline" href="<?=base_url()?>shannonprofile">Contact Shannon</a>
            </div>
          </div>
        </div>
      </section>
