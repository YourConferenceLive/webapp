...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="breadcrumbs-custom novi-background bg-cover">
        <div class="container">
          <div class="breadcrumbs-custom__inner">
            <p class="breadcrumbs-custom__title">Forms</p>
            ...
            <div class="col-md-7 col-lg-8">
              ...
              <form class="rd-mailform rd-mailform_style-1" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                <div class="form-wrap form-wrap_icon"><span class="icon novi-icon linear-icon-man"></span>
                  <input class="form-input" id="contact-name-1" type="text" name="name" data-constraints="@Required">
                  <label class="form-label" for="contact-name-1">Your name</label>
                </div>
                ...
                <div class="form-wrap form-wrap_icon"><span class="icon novi-icon linear-icon-telephone"></span>
                  <input class="form-input" id="contact-phone-1" type="text" name="phone" data-constraints="@Numeric">
                  <label class="form-label" for="contact-phone-1">Your phone</label>
                </div>
                <div class="form-wrap form-wrap_icon"><span class="icon novi-icon linear-icon-feather"></span>
                  <textarea class="form-input" id="contact-message-1" name="message" data-constraints="@Required"></textarea>
                  <label class="form-label" for="contact-message-1">Your message</label>
                </div>
            ...
            <div class="col-lg-10 col-xl-8">
              ...
              <form class="rd-mailform rd-mailform_style-1 text-center" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                <div class="form-wrap form-wrap_icon">
                  <div class="icon novi-icon linear-icon-man"></div>
                ...
                <div class="form-wrap form-wrap_icon">
                  <div class="icon novi-icon linear-icon-envelope"></div>
                  <input class="form-input" id="contact-email-2" type="email" name="email" data-constraints="@Email @Required">
                  <label class="form-label" for="contact-email-2">Your e-mail</label>
                </div>
                <div class="form-wrap form-wrap_icon">
                  <div class="icon novi-icon linear-icon-telephone"></div>
                  <input class="form-input" id="contact-phone-2" type="text" name="phone" data-constraints="@Numeric">
                  <label class="form-label" for="contact-phone-2">Your phone</label>
                </div>
                <div class="form-wrap form-wrap_icon">
                  <div class="icon novi-icon linear-icon-feather"></div>
                  <textarea class="form-input" id="contact-message-2" name="message" data-constraints="@Required"></textarea>
      ...
      <section class="text-center context-dark">
        <!-- RD Parallax-->
        <div class="parallax-container bg-image" data-parallax-img="images/parallax-03.jpg">
                ...
                <div class="col-lg-10 col-xl-8">
                  ...
                  <form class="rd-mailform rd-mailform_style-1 text-center" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                    <div class="form-wrap form-wrap_icon">
                      ...
                      <label class="form-label" for="contact-name-3">Your name</label>
                    </div>
                    <div class="form-wrap form-wrap_icon">
                      <div class="icon novi-icon linear-icon-envelope"></div>
                    ...
                    <div class="form-wrap form-wrap_icon">
                      ...
                      <label class="form-label" for="contact-phone-3">Your phone</label>
                    </div>
                    <div class="form-wrap form-wrap_icon">
                      <div class="icon novi-icon linear-icon-feather"></div>
