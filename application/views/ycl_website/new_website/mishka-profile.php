  ...
  <head>
    ...
    <link rel="icon" href="https://dev.yourconference.live/ycl_assets/ycl_icon.png">
	  ...
	  <link rel="stylesheet" href="<?=base_url()?>ycl_assets/css/style.css">
		...
		<!--[if lt IE 10]>
    <div style="background: #212121; padding: 10px 0; box-shadow: 3px 3px 5px 0 rgba(0,0,0,.3); clear: both; text-align:center; position: relative; z-index:1;"><a href="http://windows.microsoft.com/en-US/internet-explorer/"><img src="<?=base_url()?>images/ie8-panel/warning_bar_0000_us.jpg" border="0" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today."></a></div>
  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="section-xl bg-white novi-background bg-cover">
        <div class="container">
          <!-- Profile Corporate-->
          <article class="profile-corporate"><img class="profile-corporate__image" src="<?=base_url()?>ycl_assets/images/homepage_images/mishka-480x362.jpg" alt="" width="886" height="666"/>
