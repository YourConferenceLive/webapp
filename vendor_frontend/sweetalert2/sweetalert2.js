...
(function (global, factory) {
  ...
  var renderImage = function renderImage(instance, params) {
    ...
    image.setAttribute('onerror', "this.src='"+params.imageUrlOnError+"'");
