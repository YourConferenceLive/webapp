...
document.getElementById('embededVideo').addEventListener('fullscreenchange', (event) => {
	...
	if (document.fullscreenElement) {
		$("#btnFS").html('<i class="fas fa-compress-alt"></i>');
		$("#btnFS").attr("title","Exit Full Screen");
		$("iframe").removeClass("embed-responsive-item");
		$('#sessionIframe').css('height', '100vh');
		console.log(`Element: ${document.fullscreenElement.id} entered full-screen mode.`);
	} else {
		console.log('Leaving full-screen mode.');
		$("#btnFS").html('<i class="fas fa-expand-alt"></i>');
		$("#btnFS").attr("title","Full Screen");
